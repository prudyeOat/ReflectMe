...
public class LandingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LandingAdapter(RecyclerViewClickListener listener, ArrayList<String> strings) {
        mListener = listener;
...
/*
            if(position % 5 == 0){
                ((RowViewHolder) holder).image.setColorFilter(ContextCompat.getColor(context, R.color.ColorPinkNice), android.graphics.PorterDuff.Mode.MULTIPLY);
            }else if(position % 5 == 1){
                ((RowViewHolder) holder).image.setColorFilter(ContextCompat.getColor(context, R.color.ColorPop), android.graphics.PorterDuff.Mode.MULTIPLY);
            }
            */
            ...
            //    rowHolder.cardView.setBackgroundResource(R.drawable.textview_background);
             ...
             //   rowHolder.cardView.setBackgroundResource(R.drawable.white_background);
